	...
	<div class="col-md-12">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-shopping-cart"></i>广告管理
				</div>
				<div class="actions">
					<a  href="../../../advert.sp?act=addOrEdit" data-target="#ajax" class="btn default yellow-stripe" data-toggle="modal" >
						<i class="fa fa-plus"></i>
						<span class="hidden-480">新建广告</span>
					</a>
					
					<a href="advert_manager.jsp?tableId=<%=tableId %>" id="refreshBtn" class="btn default yellow-stripe ajaxify">
			...
			<div class="portlet-body">
				<div class="table-container">
					...
					<tr role="row" class="filter">
						...
						<td>
							<select name="filter_type_EQ" class="form-control form-filter input-sm">
								<option value="">------</option>
								<option value="0">web链接</option>
								<option value="1">视频详情</option>
								<option value="2">专题列表</option>								
							</select>
						</td>
						<td>
						</td>
						<td>		
						<input type="text" class="form-control form-filter input-sm" name="filter_redirectUrl_LIKE">				
						</td>	
						<td>	
						<input type="text" class="form-control form-filter input-sm" name="filter_desc_LIKE">					
						</td>						
						<td>
    ...
    var handleRecords = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": "../../../advert.sp?act=loadData", // ajax source
                },
                /*"order": [
                    [1, "asc"]
