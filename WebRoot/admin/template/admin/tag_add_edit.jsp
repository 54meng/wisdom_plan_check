...
<div class="modal-header">
	...
	<h4 class="modal-title"><%=(isNew?"新建标签":"编辑标签") %></h4>
</div>
<div class="modal-content form">
	<!-- BEGIN FORM-->
	<form action="tag.sp" enctype="multipart/form-data" method="POST" id="form_sample_1" class="form-horizontal" novalidate="novalidate">
			...
			<div class="form-group">
				...
				* </span>
				...
				<div class="col-md-7">
					...
					<input type="text" name="name" value="${tag.name }" data-required="1" class="form-control"/>
				</div>
			</div>
