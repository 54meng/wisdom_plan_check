<%@page import="com.wpc.persistence.Advert"%>
...
Advert entity = (Advert)request.getAttribute("advert");
%>
<!-- modal-content -->
<div class="modal-header">
	<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
	<h4 class="modal-title"><%=(isNew?"新建主角":"编辑主角") %></h4>
</div>
<div class="modal-content form">
	<!-- BEGIN FORM-->
	<form action="advert.sp" enctype="multipart/form-data" method="POST" id="form_sample_1" class="form-horizontal" novalidate="novalidate">
		...
		<div class="form-body">
			...
			<div class="form-group">
				<label class="control-label col-md-3">封面<span class="required">*</span></label>
				<div class="col-md-7">
					<div class="fileinput fileinput-new" data-provides="fileinput">
						<div class="fileinput-new thumbnail" style="max-width: 80px; max-height: 80px;">
							<img src="<%=(entity.getCoverUrl()!=null?"../../../"+entity.getCoverUrl():"img/placehlodit.png") %>" alt="">
						</div>
			...
			<div class="form-group">
				...
				<div class="col-md-7" style="width:150px;">
					<select class="form-control" name="type">
						<option value="0" <c:if test='${advert.type == "0"}'>selected="selected"</c:if>>web链接</option>
						<option value="1" <c:if test='${advert.type == "1"}'>selected="selected"</c:if>>视频详情</option>
						<option value="2" <c:if test='${advert.type == "2"}'>selected="selected"</c:if>>专题列表</option>
					</select>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-3">资源ID
				</label>
				<div class="col-md-7">
					<input type="hidden" name="id" value="${advert.id }" />
					<input type="text" name="resId" value="${advert.resId }" data-required="1" class="form-control" placeholder="视频ID或专题ID"/>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-3">跳转地址
				</label>
				<div class="col-md-7">
					<input type="text" name="redirectUrl" value="${advert.redirectUrl }" data-required="1" class="form-control"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-3 control-label">描述&nbsp;</label>
				<div class="col-md-7">
					<textarea name="desc" class="form-control" rows="3">${advert.desc}</textarea>
				</div>
			</div>
		</div>
