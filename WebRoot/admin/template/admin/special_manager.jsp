	...
	<div class="col-md-12">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-shopping-cart"></i>专题管理
				</div>
				<div class="actions">
					<a  href="../../../special.sp?act=addOrEdit" data-target="#ajax" class="btn default yellow-stripe" data-toggle="modal" >
						<i class="fa fa-plus"></i>
						<span class="hidden-480">新建专题</span>
					</a>
					
					<a href="special_manager.jsp?tableId=<%=tableId %>" id="refreshBtn" class="btn default yellow-stripe ajaxify">
    ...
    var handleRecords = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": "../../../special.sp?act=loadData", // ajax source
                },
                /*"order": [
                    [1, "asc"]
