<%@page import="com.wpc.persistence.User"%>
...
<div class="modal-header">
	...
	<h4 class="modal-title"><%=(isNew?"新建用户":"编辑用户") %></h4>
</div>
<div class="modal-content form">
	<!-- BEGIN FORM-->
	<form action="user.sp" enctype="multipart/form-data" method="POST" id="form_sample_1" class="form-horizontal" novalidate="novalidate">
		...
		<div class="form-body">
			...
			<div class="form-group">
				<label class="control-label col-md-3">头像<span class="required">*</span></label>
				<div class="col-md-7">
					<div class="fileinput fileinput-new" data-provides="fileinput">
						<div class="fileinput-new thumbnail" style="max-width: 80px; max-height: 80px;">
							<img src="<%=(user.getAvatar_url()!=null?"../../../"+user.getAvatar_url():"img/placehlodit.png") %>" alt="">
						</div>
			...
			<div class="form-group">
				...
				<div class="col-md-7" style="width:110px;">
					<select class="form-control" name="userStatus">
						<option value="1" <c:if test='${user.userStatus == "1"}'>selected="selected"</c:if>>启用</option>
			...
			<div class="form-group">
				...
				* </span></label>
				<div class="col-md-7" style="width:160px;">
					<select class="form-control" name="userRole" data-required="1">
						<option value="">------------</option>
						<option value="1" <c:if test='${user.userRole == "1"}'>selected="selected"</c:if>>管理员</option>
						<option value="2" <c:if test='${user.userRole == "2"}'>selected="selected"</c:if>>分管经理</option>
						<option value="3" <c:if test='${user.userRole == "3"}'>selected="selected"</c:if>>采购人员</option>
						<option value="4" <c:if test='${user.userRole == "4"}'>selected="selected"</c:if>>辅助审批专员</option>
					</select>
				</div>
			</div>
			<div class="form-group">
				...
				* </span>
				...
				<div class="col-md-7">
					...
					<input type="text" name="username" value="${user.username}" data-required="1" class="form-control"/>
				</div>
			</div>
			
			<div class="form-group">
				<label class="control-label col-md-3">登录密码<span class="required">
				* </span>
				</label>
				<div class="col-md-7">
					<input type="password" name="password" id="password" value="${user.password}" data-required="1" class="form-control"/>
				</div>
			</div>
			<div class="form-group">
				...
				* </span>
				...
				<div class="col-md-7">
					<input type="password" name="password2" value="${user.password}" data-required="1" class="form-control"/>
				</div>
			</div>
			<div class="form-group">
				...
				* </span>
				...
				<div class="col-md-7">
					<input type="text" name="phone" value="${user.phone}" data-required="1" class="form-control"/>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label class="control-label col-md-3">允许登录</label>
				<div class="col-md-7" style="width:110px;">
					<select class="form-control" name="allowLogin">
						<option value="0" <c:if test='${user.allowLogin == "0"}'>selected="selected"</c:if>>否</option>
						<option value="1" <c:if test='${user.allowLogin == "1"}'>selected="selected"</c:if>>是</option>						
					</select>
				</div>
			</div>
...
var handleValidation = function() {
        ...
        form1.validate({
            ...
            messages: {
                ...
                phone: {
                    minlength: jQuery.validator.format("至少{0}个字符"),
