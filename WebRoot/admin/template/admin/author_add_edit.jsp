<%@page import="com.wpc.persistence.Author"%>
...
Author entity = (Author)request.getAttribute("author");
%>
<!-- modal-content -->
...
<div class="modal-content form">
	<!-- BEGIN FORM-->
	<form action="author.sp" enctype="multipart/form-data" method="POST" id="form_sample_1" class="form-horizontal" novalidate="novalidate">
			...
			<div class="form-group">
				...
				* </span>
				...
				<div class="col-md-7">
					...
					<input type="text" name="name" value="${author.name }" data-required="1" class="form-control"/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-3 control-label">简介&nbsp;</label>
				<div class="col-md-7">
					<textarea name="intros" class="form-control" rows="3">${author.intros}</textarea>
				</div>
			</div>
		</div>
