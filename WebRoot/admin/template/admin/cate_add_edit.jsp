<%@page import="com.wpc.persistence.Category"%>
...
Category entity = (Category)request.getAttribute("category");
%>
<!-- modal-content -->
<div class="modal-header">
	<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
	<h4 class="modal-title"><%=(isNew?"新建分类":"编辑分类") %></h4>
</div>
<div class="modal-content form">
	<!-- BEGIN FORM-->
	<form action="cate.sp" enctype="multipart/form-data" method="POST" id="form_sample_1" class="form-horizontal" novalidate="novalidate">
		...
		<div class="form-body">
			...
			<div class="form-group">
				<label class="control-label col-md-3">分类名称<span class="required">
				* </span>
				</label>
				<div class="col-md-7">
					<input type="hidden" name="cateId" value="${category.cateId }" />
					<input type="text" name="cateName" value="${category.cateName }" data-required="1" class="form-control"/>
				</div>
			</div>
