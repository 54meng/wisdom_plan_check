	...
	<div class="col-md-12">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-shopping-cart"></i>主角管理
				</div>
				<div class="actions">
					<a  href="../../../author.sp?act=addOrEdit" data-target="#ajax" class="btn default yellow-stripe" data-toggle="modal" >
						<i class="fa fa-plus"></i>
						<span class="hidden-480">新建主角</span>
					</a>
					
					<a href="author_manager.jsp?tableId=<%=tableId %>" id="refreshBtn" class="btn default yellow-stripe ajaxify">
    ...
    var handleRecords = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": "../../../author.sp?act=loadData", // ajax source
                },
                /*"order": [
                    [1, "asc"]
