	...
	<div class="col-md-12">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-shopping-cart"></i>分类管理
				</div>
				<div class="actions">
					<a  href="../../../cate.sp?act=addOrEdit" data-target="#ajax" class="btn default yellow-stripe" data-toggle="modal" >
						<i class="fa fa-plus"></i>
						<span class="hidden-480">新建分类</span>
					</a>
					
					<a href="cate_manager.jsp?tableId=<%=tableId %>" id="refreshBtn" class="btn default yellow-stripe ajaxify">
			...
			<div class="portlet-body">
				<div class="table-container">
					...
					<tr role="row" class="filter">
						...
						<td>
							<input type="text" class="form-control form-filter input-sm" name="filter_cateName_LIKE">
						</td>						
						<td>
    ...
    var handleRecords = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": "../../../cate.sp?act=loadData", // ajax source
                },
                /*"order": [
                    [1, "asc"]
