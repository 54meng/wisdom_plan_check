...
<!-- BEGIN PAGE HEADER-->
<h3 class="page-title">
采购通知管理 <small>对采购通知进行增删改查</small>
</h3>
<!-- BEGIN PAGE CONTENT-->
<div class="row">
	<div class="col-md-12">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-shopping-cart"></i>采购通知管理
				</div>
				<div class="actions">
					<a  href="../../../purchaseNotice.sp?act=addOrEdit" data-target="#ajax" class="btn default yellow-stripe" data-toggle="modal" >
						<i class="fa fa-plus"></i>
						<span class="hidden-480">新建采购通知</span>
					</a>
					
					<a href="purchase_notice_manager.jsp?tableId=<%=tableId %>" id="refreshBtn" class="btn default yellow-stripe ajaxify">
			...
			<div class="portlet-body">
				<div class="table-container">
					...
					<tr role="row" class="filter">
						...
						<td>
							<input type="text" class="form-control form-filter input-sm" name="filter_content_LIKE">
						</td>			
						<td>										
						</td>	
						<td>	
    ...
    var handleRecords = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "ajax": {
                    "url": "../../../purchaseNotice.sp?act=loadData", // ajax source
                },
                /*"order": [
                    [1, "asc"]
